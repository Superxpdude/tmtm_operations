...
class victory
{
	...
	subtitle = "Hostile forces are retreating."; // Subtitle below the title when the closing shot is triggered
	description = "The enemy assault force has given up their attempt to capture Artillery Base Alpha. NATO forces are in the process of organizing a counter-attack to push the remaining enemy forces out of Chernarus."; // Description visible on the debriefing screen after the closing shot
...
class failure
{
	...
	subtitle = "Artillery Base Alpha has fallen to enemy forces."; // Subtitle below the title when the closing shot is triggered
	description = "Artillery Base Alpha has been captured by the invading enemy forces. Remaining NATO forces are scattered and without support; any groups capable of doing so are beginning their evacuation of the surrounding areas."; // Description visible on the debriefing screen after the closing shot
	pictureBackground = "media\loadscreen.paa"; // Image file used as a background on the debriefing screen
	//picture = ""; // Icon used for the closing shot
	//pictureColor[] = {1,1,1,1}; // Colour of the icon during the closing shot. Leave as default most of the time
};