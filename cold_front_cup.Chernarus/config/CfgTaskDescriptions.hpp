...
class task_defend_alpha
{
	title = "Defend Artillery Base Alpha";
	description = "Defend Artillery Base Alpha from the impending enemy assault.";
	marker = "marker_arty_base";
};
