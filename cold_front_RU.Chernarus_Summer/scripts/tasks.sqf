...
// Create tasks
[[true, "zeus_unit"], "defend_alpha", ["Defend Artillery Base Alpha from the impending American assault.", "Defend Artillery Base Alpha", "marker_arty_base"], getMarkerPos "marker_arty_base", "CREATED", 0, true, "defend", true] call BIS_fnc_taskCreate;
[[true, "zeus_unit"], "defend_aar", ["Defend the Gorka Anti-Air Radar from American attackers.", "Defend the Anti-Air Radar", ""], aar, "ASSIGNED", 10, true, "defend", true] call BIS_fnc_taskCreate;